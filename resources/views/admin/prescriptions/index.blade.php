                    ...
                    <tr class="transition-colors hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex items-center justify-center gap-2">
                                <form method="POST" action="{{ route('admin.prescriptions.approve', $prescription['no']) }}" class="inline">
                                    @csrf
                                    <button type="submit" 
                                ...
                                <form method="POST" action="{{ route('admin.prescriptions.reject', $prescription['no']) }}" class="inline">
                                    @csrf
                                    <button type="submit"
                                            onclick="return confirm('Reject this prescription request?')"
