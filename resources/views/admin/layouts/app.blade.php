                    ...
                    <div x-data="{ open: {{ request()->routeIs('admin.users.*') ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-collapse class="mt-2 ml-8 space-y-2">
                            <a href="{{ route('admin.users.index', ['tab' => 'patients']) }}" 
                               class="block px-4 py-2 text-sm transition-colors rounded-lg {{ request()->input('tab') === 'patients' || !request()->has('tab') ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:bg-gray-50' }}">
                                Patient
                            </a>
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-200 shadow-sm">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <!-- Notification Bell -->
                    <button class="relative p-2 text-gray-600 transition-colors rounded-lg hover:bg-gray-100">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50">
                <div class="p-6">
                    @if(session('success'))
                        <div class="p-4 mb-6 text-green-800 bg-green-100 border-l-4 border-green-500 rounded-lg" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)">
