...
|--------------------------------------------------------------------------
|
| Here are all routes for the admin panel. These routes are protected
| by the 'auth' and 'admin' middleware to ensure only admins can access.
|
*/
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Health Records Management (Patient Records)
    Route::get('/patient-records', [HealthRecordController::class, 'index'])->name('patient-records.index');
    Route::get('/patient-records/create', [HealthRecordController::class, 'create'])->name('patient-records.create');
    Route::post('/patient-records', [HealthRecordController::class, 'store'])->name('patient-records.store');
    Route::get('/patient-records/{record}', [HealthRecordController::class, 'show'])->name('patient-records.show');
    Route::get('/patient-records/{record}/edit', [HealthRecordController::class, 'edit'])->name('patient-records.edit');
